...
Status: prototype / work in progress. Authentication is not implemented and every API endpoint is currently public. Do not deploy this against real client data until the items in Security status are resolved.
...
Cases	GET /cases, GET /cases/:id, POST /cases, PATCH /cases/:id, DELETE /cases/:id, GET /cases/conflict-check, `GET
...
Chat	`GET
AI drafts	`GET
AI	POST /ai/ask (SSE), POST /ai/generate-draft, `GET
Data model
Table	Purpose
